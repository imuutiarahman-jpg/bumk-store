...
<?php if($_GET['hapus']==='ok'): ?><div class="px-4 py-3 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-700 text-sm font-medium">Transaksi #<?= (int)($_GET['id']??0) ?> dihapus, stok dikembalikan.</div>
<?php elseif($_GET['hapus']==='tidak-ada'): ?><div class="px-4 py-3 rounded-2xl bg-rose-50 border border-rose-200 text-rose-700 text-sm font-medium">Transaksi tidak ditemukan (mungkin sudah dihapus).</div>
<?php else: ?><div class="px-4 py-3 rounded-2xl bg-rose-50 border border-rose-200 text-rose-700 text-sm font-medium">Gagal menghapus transaksi.</div><?php endif; ?>
<?php endif; ?>
