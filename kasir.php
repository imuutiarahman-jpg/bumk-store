...
<div class="flex-1 overflow-y-auto p-4 custom-scrollbar"><div id="grid" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4"></div></div>
</div>
